  ...
  return (
    <div className="mt-2 border-t border-white/10 pt-3">
      <button
        ...
        disabled={pending}
        className="w-full touch-manipulation rounded-full bg-white/10 px-4 py-2.5 text-sm font-medium text-canopee-cream transition-colors hover:bg-white/20 disabled:opacity-50"
      >
