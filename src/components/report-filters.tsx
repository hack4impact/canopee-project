    ...
    <>
      ...
      {open && (
        <section
          ...
          className="absolute top-[calc(5rem+env(safe-area-inset-top))] right-4 z-10 w-64 space-y-1 rounded-2xl bg-canopee-forest/80 p-3 text-canopee-cream shadow-xl shadow-black/30 ring-1 ring-white/10 backdrop-blur-sm"
        >
          {groups.map((group) => {
